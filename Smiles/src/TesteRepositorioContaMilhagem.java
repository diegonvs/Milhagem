public class TesteRepositorioContaMilhagem {
	...
	public static void main(String[] args) {
		...
		Cliente c4 = new Cliente("97344615401", "Não está no Repositório", 99, 9999, 0);
		...
		////////////////////////////////////////////////////////////////////////////////
		//Incluindo as conta milhagens cm1,cm2,cm3 [A CONTA MILHAGEM "cm4" não foi inserida!]
		rcm1.incluir(cm1);
		rcm1.incluir(cm2);
		rcm1.incluir(cm3);
		//no método buscar quando se retorna "null" é pq a conta existe qd retorna true não existe.
 		////////////////////////////////////////////////////////////////////////////////
