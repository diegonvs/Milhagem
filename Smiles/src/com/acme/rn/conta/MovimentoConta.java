...
public abstract class MovimentoConta extends Registro {
	...
	public void validar() throws AtributoInvalidoException {
		if(this.contaMilhagemdeOrigem.equals(null)){
			throw new AtributoInvalidoException("Conta Milhagem n„o pode ser null");
		}
		if(this.valorTransacao <= 0){
			throw new AtributoInvalidoException("Valor n„o pode ser menor ou igual a zero!");
		}
		if(this.nomedaFonte.length() > 100){
			throw new AtributoInvalidoException("N„o pode conter mais que 100 caracteres.");
		}
		if(this.date.equals(null)){
			throw new AtributoInvalidoException("Date n„o pode ser null");
		}
	}
}
